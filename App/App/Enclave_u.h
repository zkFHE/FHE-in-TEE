...
/**** ECALL prototypes. ****/
oe_result_t ecall_InitEnclave(oe_enclave_t* enclave);

oe_result_t ecall_SendInputs(oe_enclave_t* enclave);

oe_result_t ecall_StoreInput(
    oe_enclave_t* enclave,
    int index,
    unsigned char* buffer,
    size_t len);

oe_result_t ecall_MultiplyOutsource(
    oe_enclave_t* enclave,
    int input1,
    int input2,
    int output);

oe_result_t ecall_MultiplyOutsource_BenchHost(
    oe_enclave_t* enclave,
    int input1,
    int input2,
    int output);

oe_result_t ecall_Multiply(
    oe_enclave_t* enclave,
    int input1,
    int input2,
    int output);

oe_result_t ecall_VerifyMult(
    oe_enclave_t* enclave,
    int input1,
    int input2,
    int output);

oe_result_t ecall_VerifyMultBatch_1(oe_enclave_t* enclave);

oe_result_t ecall_VerifyMultBatch(
    oe_enclave_t* enclave,
    int NUM_CTXTS);

oe_result_t ecall_Tiny(oe_enclave_t* enclave);

oe_result_t ecall_Small(oe_enclave_t* enclave);

oe_result_t ecall_Medium(oe_enclave_t* enclave);
