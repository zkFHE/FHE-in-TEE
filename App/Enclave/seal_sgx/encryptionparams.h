...
#include "seal_sgx/modulus.h"
#include "seal_sgx/randomgen.h"
#include "seal_sgx/serialization.h"
#include "seal_sgx/version.h"
#include "seal_sgx/util/defines.h"
#include "seal_sgx/util/globals.h"
#include "seal_sgx/util/hash.h"
#include "seal_sgx/util/ztools.h"
#include <functional>
#include <iostream>
#include <memory>
#include <numeric>
    ...
    */
    ...
    public:
        ...
        */
        ...
        /**
        Enables access to private members of seal_sgx::EncryptionParameters for SEAL_C.
        */
...
{
    template <>
    struct hash<seal_sgx::parms_id_type>
    {
        std::size_t operator()(const seal_sgx::parms_id_type &parms_id) const
        {
    ...
    template <>
    struct hash<seal_sgx::EncryptionParameters>
    {
        std::size_t operator()(const seal_sgx::EncryptionParameters &parms) const
        {
            hash<seal_sgx::parms_id_type> parms_id_hash;
