...
#include "seal_sgx/util/defines.h"
...
namespace seal_sgx
{
    ...
    namespace util
    {
        ...
        to use with the SEAL_ITERATE macro, which expands to std::for_each_n in C++17 and to seal_sgx::util::seal_for_each_n
        ...
        The individual components of an IterTuple can be accessed with the seal_sgx::util::get<i>(...) functions. The
        ...
        expands to seal_sgx::util::seal_for_each_n -- a custom implementation. For example, the following snippet appears
        ...
        There are two important coding conventions in the above code snippets that are to be observed:
            ...
            3. The only exception to 2. is when SEAL_ITERATE operates on a single PtrIter<T *>: dereferencing returns a
               ...
               seal_sgx::util::ntt_negacyclic_harvey in seal/util/ntt.h, where the lambda function parameter is auto &.
        ...
        seal_sgx::util::negate_poly_coeffmod can negate a single RNS component modulo a given Modulus (CoeffIter overload),
        ...
        probably a good idea to call seal_sgx::util::allocate inside the lambda function for any allocations needed, rather
        ...
        */
        ...
        public:
            static_assert(
                ...
                "Template parameter must derive from seal_sgx::util::SEALIterBase");
        ...
        public:
            ...
            {
                static_assert(
                    sizeof...(Ts) == sizeof...(Rest) + 1, "std::tuple size does not match seal_sgx::util::IterTuple size");
            }
        ...
        namespace iterator_internal
        {
            ...
            {
                static_assert(N < sizeof...(SEALIters), "seal_sgx::util::IterTuple index out of range");
