...
void ecall_StoreInput(
    int index,
    unsigned char* buffer,
    size_t len);

void ecall_MultiplyOutsource(
    int input1,
    int input2,
    int output);

void ecall_MultiplyOutsource_BenchHost(
    int input1,
    int input2,
    int output);
...
void ecall_VerifyMult(
    int input1,
    int input2,
    int output);

void ecall_VerifyMultBatch_1(void);

void ecall_VerifyMultBatch(int NUM_CTXTS);

void ecall_Tiny(void);

void ecall_Small(void);

void ecall_Medium(void);
